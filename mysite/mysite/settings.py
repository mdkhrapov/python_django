...
SECRET_KEY = getenv(
    "DJANGO_SECRET_KEY",
    'django-insecure-w$42j*jxrc#au1_to=3sgkkc&r@wbad&c01aw#o40(+%f^u7h9',
)
...
INSTALLED_APPS = [
    ...
    'django_filters',
    'drf_spectacular',
    'start_index.apps.StartIndexConfig',
...
logging.config.dictConfig({
    ...
    "formatters": {
        "console": {
            "format": "%(asctime)s %(levelname)s [%(name)s:%(linena)s] %(module)s %(message)s",
        },
    },
    "handlers": {
        "console": {
